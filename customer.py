class Customer:
    def __init__(self, customer_id, customer_name, company_name, email, phone, address,
    ...
    def __str__(self):
        return (f"ID: {self.customer_id}, Name: {self.customer_name}, Company: {self.company_name}, "
